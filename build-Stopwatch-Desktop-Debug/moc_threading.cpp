...
QT_MOC_LITERAL(1, 10, 12), // "countChanges"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "value"

    },
    "Threading\0countChanges\0\0value"
};
...
void Threading::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Threading *_t = static_cast<Threading *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->countChanges((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Threading::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Threading::countChanges)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Threading::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Threading.data,
      qt_meta_data_Threading,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Threading::countChanges(int _t1)
{
